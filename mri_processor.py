...
if answer3 == 'y':
    ...
    center_y = dim2 // 2
    center_z = dim3 // 2
    result4 = subprocess.run(['fsleyes', 'render', '-of', screenshot_file, binary_nifti_image, '-ot', 'mask', '-mc', '1', '0', '0', '--worldLoc', f'{center_x}', f'{center_y}', f'{center_z}', functional_image], capture_output=True, text=True)

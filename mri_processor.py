...
if answer3 == 'y':
    ...
    center_y = dim2 // 2
    center_z = dim3 // 2
    result4 = subprocess.run(['fsleyes', 'render', '-of', screenshot_file, binary_nifti_image, '-ot', 'mask', '-mc', '1', '0', '0', functional_image, '-hc', str(center_x), str(center_y), str(center_z)], capture_output=True, text=True)

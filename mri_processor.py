...
if answer3 == 'y':
    ...
    result4 = subprocess.run(['fsleyes', 'render', '--voxelLoc', f'{center_x}', f'{center_y}', f'{center_z}', '-of', screenshot_file, functional_image, binary_nifti_image, '-ot', 'mask', '-mc', '1', '0', '0'], capture_output=True, text=True)

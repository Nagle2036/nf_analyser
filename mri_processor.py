...
if answer3 == 'y':
    ...
    for p_id in participants_to_iterate:
        if p_id in good_participants:            
            ...
            subprocess.run(['flirt', '-in', averaged_run, '-ref', structural_brain, '-out', f'{p_id}/analysis/preproc/fieldmaps/pe_test/2/temp_file.nii.gz', '-omat', f'{p_id}/analysis/preproc/fieldmaps/pe_test/2/roi_transformation'])
